					...
					<div class="contact_form_container">
						...
						<form action="#" id="contact_form">
							<div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
								<h3>Nombres:</h3>
								<input type="text" id="contact_form_name" class="contact_form_name input_field" placeholder="${user.getNombres()}" required="required" data-error="Name is required." readonly="readonly" ><br>
								<h3>Correo:</h3>
								<input type="text" id="contact_form_email" class="contact_form_email input_field" placeholder="${user.getCorreo()}" required="required" data-error="Email is required." readonly="readonly">
