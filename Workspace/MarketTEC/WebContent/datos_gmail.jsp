						...
						<div class="top_bar_content ml-auto">
								...
								<c:choose>
								    <c:when test="${user==null}">
								    	<div>
											...
											<a href="datos_gmail.jsp?id=<%=id %>&name=<%=name %>&email=<%=email %>" class="hvr-overline-from-center scroll">Mi cuenta</a>	
										</div>
								         
								    </c:when>    
								    <c:otherwise>
								        <div>
											<a onclick="checkLoginState()" class="hvr-overline-from-center scroll">Mi cuenta</a>
										</div>
										 <div>
							...
							<div class="top_bar_user">
								...
								<c:choose>
								    <c:when test="${user==null}">
								    	<div>
											<a href="index.jsp" class="hvr-overline-from-center scroll" onclick="myFunction()">Salir</a>
										</div>
								         
								    </c:when>    
								    <c:otherwise>
								        <div>
											<a href="datos_gmail.jsp" class="hvr-overline-from-center scroll">Mi cuenta</a>
										</div>
										 <div>
											<a href="index_fb_log.jsp" class="hvr-overline-from-center scroll" onclick="myFunction()">Salir</a>
										</div>
								    </c:otherwise>
								</c:choose>
					...
					<div class="contact_form_container">
						...
						<form  id="contact_form">
							<div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
								<h3>Nombres:</h3>
								<input type="text" id="contact_form_name" class="contact_form_name input_field" placeholder="<%=name%>" required="required" data-error="Name is required." readonly="readonly" ><br>
								<h3>Correo:</h3>
								<input type="text" id="contact_form_email" class="contact_form_email input_field" placeholder="<%=email%>" required="required" data-error="Email is required." readonly="readonly">
								
								
							</div>
							
							<div class="contact_form_button">
								<button type="submit" class="button contact_submit_button" onclick="window.location.href='index_gmail_log.jsp'">Volver</button>
							</div>
						</form>
